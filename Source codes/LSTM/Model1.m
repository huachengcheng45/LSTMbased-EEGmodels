...
numHiddenUnits1=80; % num of units in hidden layer1
numHiddenUnits2=80; % num of units in hidden layer2
numHiddenUnits3=80; % num of units in hidden layer3
layers = [
...
layers = [
    ...
    dropoutLayer(0.25,'Name','drop3')
    lstmLayer(numHiddenUnits4, 'OutputMode', 'sequence','Name','lstm4')
    dropoutLayer(0.25,'Name','drop4')
    lstmLayer(numHiddenUnits5, 'OutputMode', 'last','Name','lstm5')
    dropoutLayer(0.25,'Name','drop5')
    fullyConnectedLayer(100,'Name','fc1')
...
lgraph = layerGraph(layers);analyzeNetwork(layers);
...
% Save the results
save cv_m1_3lstm80_result net info loss all_ytest all_ypred indices
