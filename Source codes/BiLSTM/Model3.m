...
layers = [
    ...
    % 3-layer BiLSTM
    bilstmLayer(numHiddenUnits1, 'OutputMode', 'sequence','Name','bilstm1')
    dropoutLayer(0.25,'Name','drop1')
    bilstmLayer(numHiddenUnits2, 'OutputMode', 'sequence','Name','bilstm2')
    dropoutLayer(0.25,'Name','drop2')
    bilstmLayer(numHiddenUnits3, 'OutputMode', 'last','Name','bilstm3')
...
% Save the results
save cv_m3_3bilstm70_result net info loss all_ytest all_ypred indices
