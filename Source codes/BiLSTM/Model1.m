...
numHiddenUnits1=40; % num of units in hidden layer1
numHiddenUnits2=40; % num of units in hidden layer2
numHiddenUnits3=40; % num of units in hidden layer3
layers = [
...
% Save the results
save cv_m1_3bilstm40_result net info loss all_ytest all_ypred indices
